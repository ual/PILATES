...
if __name__ == '__main__':
    ...
    warm_start_skims = False # settings['warm_start_skims']
    static_skims = True # settings['static_skims']
    land_use_enabled = False # settings['land_use_enabled']
    vehicle_ownership_model_enabled = True # settings['vehicle_ownership_model_enabled'] # Atlas
    activity_demand_enabled = False # settings['activity_demand_enabled']
    traffic_assignment_enabled = False # settings['traffic_assignment_enabled']
    replanning_enabled = False # settings['replanning_enabled']
