...
parser.add_argument('-vot_level', type=int, default=0, help='use 0 for VOTT low (from Scenario settings file - i.e. long run) and 1 for VOTT high (short run/less impact)')
...
skims = sr.Skim_Results()
sr.Main(skims, auto_skim_path, transit_skim_path)
...
sr.WriteSkimsHDF5(args.database_name + '_urbansim_skims.hdf5', skims)
print('Done.')
